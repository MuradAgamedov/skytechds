...
class EmailPolicy
{
    ...
    {
        return $user->hasPermissionTo('email.read');
    }
    ...
    {
        return $user->hasPermissionTo('email.create');
    }
    ...
    {
        return $user->hasPermissionTo('email.update');
    }
    ...
    {
        return $user->hasPermissionTo('email.delete');
    }
