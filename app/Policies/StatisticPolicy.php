...
class StatisticPolicy
{
    ...
    {
        return $user->hasPermissionTo('statistic.read');
    }
    ...
    {
        return $user->hasPermissionTo('statistic.create');
    }
    ...
    {
        return $user->hasPermissionTo('statistic.update');
    }
    ...
    {
        return $user->hasPermissionTo('statistic.delete');
    }
