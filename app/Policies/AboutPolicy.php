...
class AboutPolicy
{
    ...
    {
        return $user->hasPermissionTo('about.read');
    }
    ...
    {
        return $user->hasPermissionTo('about.create');
    }
    ...
    {
        return $user->hasPermissionTo('about.update');
    }
    ...
    {
        return $user->hasPermissionTo('about.delete');
    }
