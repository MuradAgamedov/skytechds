...
class SiteInfoPolicy
{
    ...
    {
        return $user->hasPermissionTo('siteinfo.read');
    }
    ...
    {
        return $user->hasPermissionTo('siteinfo.create');
    }
    ...
    {
        return $user->hasPermissionTo('siteinfo.update');
    }
    ...
    {
        return $user->hasPermissionTo('siteinfo.delete');
    }
